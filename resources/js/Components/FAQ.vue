            ...
            <div class="grid gap-6 lg:grid-cols-3">
                <div class="mb-6 md:mb-8 lg:mb-12">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-300">
                        ...
                        eligendi libero eveniet dolorem, doloremque rem aliquid
                        perferendis.
                    </p>
                </div>
                ...
                <div class="mb-6 md:mb-8 lg:mb-12">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-300">
                        ...
                        suscipit? Minima sunt at nulla tenetur, numquam unde
                        quod modi magnam ab deserunt ipsam sint aliquid dolores
                        libero repellendus cupiditate mollitia quidem dolorem
                        odit
                    </p>
                </div>
                ...
                <div class="mb-6 md:mb-8 lg:mb-12">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-300">
                        ...
                        reiciendis, velit adipisci quas.
                    </p>
                </div>
