...
<body class="clean-body u_body"
    style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #edf4f5;color: #000000">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-size: 35px; font-weight: 400;">
                                                                <span><span><strong>Formulário de
                                                                            Contato</strong><strong><br /></strong></span></span>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">De:
                                                                    {{ $data['fromName'] }}</p>
                                                                <p style="line-height: 140%;">Para: TMKT Londrina</p>
                                                            </div>
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                                    <div
                                        style="background-color: #30b3f1;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            ...
                                            <table id="u_content_text_2"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 100px 30px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div class="v-font-size"
                                                                style="font-size: 14px; color: #ffffff; line-height: 170%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 170%;"> Desde 2004, a TMKT
                                                                    LONDRINA oferece soluções de telemarketing ativo
                                                                    para grandes empresas do setor editorial de revistas
                                                                    e plataformas digitais. </p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                style="font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 22px; color: #ffffff; line-height: 300%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 300%;">TMKT Londrina</p>
                                                            </div>
